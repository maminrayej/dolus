...
public class HashMapBasedQueryTreeRecordManager extends QueryTreeRecordManager<String,String> {
    ...
    public boolean addGeneratedAliases(String tableAlias, String generatedTableAlias, String tableName, String generatedTableName){
        ...
        record.addGeneratedTablesAlias(tableAlias, generatedTableAlias);
    ...
    /**
     * Get the table alias generated for the original table alias used in the query
     *
     * @param tableAlias original table alias
     * @return generated table alias, null if there is no generated alias for the specified table alias
     */
    public String getGeneratedTableAlias(String tableAlias){
        ...
        return record.getGeneratedTableAlias(tableAlias);
